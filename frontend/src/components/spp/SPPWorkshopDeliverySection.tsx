                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {item.delivery_status === 'REJECTED' && (
                      <button
                        ...
                        className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700 hover:bg-red-200 transition-colors cursor-pointer"
                      >
                        ❌ Rejected
                      </button>
                    )}
